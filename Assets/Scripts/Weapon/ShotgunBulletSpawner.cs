...
public class ShotgunBulletSpawner : BulletSpawner
{
    ...
    public override void SpawnBullet(WeaponStats bulletData, Vector3 spawnPosition, Vector2 baseDirection, bool isMove)
    {
        for (int i = 0; i < _pelletCount; i++)
        {
            ...
            base.SpawnBullet(bulletData, spawnPosition, pelletDirection, isMove);
        }
    }
}